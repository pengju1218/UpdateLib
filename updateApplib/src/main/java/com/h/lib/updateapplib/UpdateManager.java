...
public class UpdateManager {
    ...
    public static class Builder {
        ...
        public Builder setUpdateInfoEntity(UpdateInfoEntity updateInfoEntity) {
            mUpdateInfoEntity = updateInfoEntity;
            return this;
        }
        ...
        public void check() {
            ...
            sLastTime = now;
            UpdateAgent agent = new UpdateAgent(mContext, mUpdateInfoEntity, mIsManual, mIsWifiOnly);
