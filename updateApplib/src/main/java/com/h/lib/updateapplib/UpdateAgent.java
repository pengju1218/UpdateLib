...
package com.h.lib.updateapplib;
...
import com.h.lib.updateapplib.entity.UpdateInfoEntity;
...
public class UpdateAgent {
    ...
    public interface InfoParser {
        UpdateInfoEntity parse(String source) throws Exception;
    }
    ...
    public UpdateAgent(Context context, UpdateInfoEntity updateInfoEntity, boolean isManual, boolean isWifiOnly) {
        mContext = context;
        mIsManual = isManual;
        mIsWifiOnly = isWifiOnly;
        mOnPromptListener = new OnPrompt(context);
        mOnFailureListener = new OnFailure(context);
        mInfo = updateInfoEntity;
    }


    public UpdateInfoEntity getInfo() {
        return mInfo;
    }

    public void setInfo(UpdateInfoEntity info) {
        mInfo = info;
    }
    ...
    public void parse(UpdateInfoEntity updateInfoEntity) {

        try {
            setInfo(updateInfoEntity);
            checkFinish();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private static class OnPrompt implements OnPromptListener {
        ...
        public void onPrompt(UpdateAgent agent) {
            final UpdateInfoEntity info = agent.getInfo();
